...
def main():
    ...
    controlnet = ControlNetModel.from_pretrained('./normal_controlnet')
    ...
    for epoch in range(0, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(anon_adapter):
                ...
                # uloss,id_loss1,id_loss2 = compute_image_loss(noise_pred,noisy_latents,timesteps.cpu(),vae,noise_scheduler,x0=batch["images"],src_ID=src_poor_ID,id_model=ID_encoder,device=accelerator.device)                
                # loss += uloss
